      ...
      <div className="lokki-container">
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull1.jpg" alt="Image 1" />
          </div>
        ...
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull2.jpg" alt="Image 2" />
        ...
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull3.jpg" alt="Image 3" />
          </div>
        </div>
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull4.jpg" alt="Image 4" />
          </div>
          <div className="lokki-text">
        ...
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull5.jpg" alt="Image 1" />
          </div>
          <div className="lokki-text">
        ...
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull6.jpg" alt="Image 2" />
          </div>
        </div>
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull7.jpg" alt="Image 3" />
            <div className="lokki-text">
        ...
        <div className="lokki-item">
          <div className="lokki-image">
            <img src="./src\assets\gull8.jpg" alt="Image 4" />
            <div className="lokki-text">
